...
React Native Live Markdown requires [react-native-worklets](https://github.com/margelo/react-native-worklets) 0.6.0 or newer as well as [expensify-common](https://github.com/Expensify/expensify-common) 2.0.115 and [html-entities](https://github.com/mdevils/html-entities) 2.5.3 exactly if using the default built-in ExpensiMark parser.
...
Parser needs to be marked as a [worklet](https://github.com/margelo/react-native-worklets) because it's executed on the UI thread as the user types.
